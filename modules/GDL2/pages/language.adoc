...
image::diagrams/gdl2_guideline_structure.svg[id=gdl2_guideline_structure, align="center"]
...
image::diagrams/gdl2_execution_model.svg[id=gdl2_execution_model, align="center", width=70%]
