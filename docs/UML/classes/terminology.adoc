...
h|*1..1*
|*is_differential*: `link:/releases/BASE/{cds_release}/foundation_types.html#_boolean_class[Boolean^]`
a|Indicates whether this terminology is differential with respect to a specialisation parent, or complete.

h|*1..1*
|*original_language*: `link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^]`
...
h|*1..1*
|*concept_code*: `link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^]`
...
h|*1..1*
|*term_definitions*: `link:/releases/BASE/{cds_release}/foundation_types.html#_hash_class[Hash^]<link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^], link:/releases/BASE/{cds_release}/foundation_types.html#_hash_class[Hash^]<link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^], <<_term_class,TERM>>>>`
...
h|*0..1*
|*term_bindings*: `link:/releases/BASE/{cds_release}/foundation_types.html#_hash_class[Hash^] <link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^], <<_term_binding_class,TERM_BINDING>>>`
...
h|*1..1*
|*specialisation_depth* (): `link:/releases/BASE/{cds_release}/foundation_types.html#_integer_class[Integer^]`
...
h|*1..1*
|*has_language* ( +
a_lang: `link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^][1]` +
...
h|*1..1*
|*has_terminology* ( +
a_terminology_id: `link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^][1]` +
): `link:/releases/BASE/{cds_release}/foundation_types.html#_boolean_class[boolean^]`
...
h|*1..1*
|*has_term_code* ( +
a_code: `link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^][1]` +
): `link:/releases/BASE/{cds_release}/foundation_types.html#_boolean_class[boolean^]`
...
h|*1..1*
|*term_binding* ( +
a_terminology: `link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^][1]`, +
a_code: `link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^][1]` +
...
h|*1..1*
|*terminologies_available* (): `link:/releases/BASE/{cds_release}/foundation_types.html#_list_class[List^]<link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^]>`
a|List of terminologies to which term or constraint bindings exist in this terminology, computed from bindings.

h|*1..1*
|*languages_available* (): `link:/releases/BASE/{cds_release}/foundation_types.html#_list_class[List^]<link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^]>`
