...
h|*1..1*
|*model_id*: `link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^]`
a|Identifier of a model that defines the structure of the `_object_`.

h|*0..1*
|*template_id*: `link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^]`
a|The identifier of a template based on the model identified by `_model_id_` defining the attached `_object_`.

h|*1..1*
|*object*: `link:/releases/BASE/{cds_release}/foundation_types.html#_string_class[String^]`
